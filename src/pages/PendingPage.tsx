...
import { CiClock2 } from 'react-icons/ci'; // Icono de pendiente
    ...
    return (
        <div className='flex flex-col h-screen'>
            ...
            <main className='container flex-1 flex flex-col items-center gap-10'>
                ...
                <div className='border border-yellow-200 bg-yellow-50 w-full md:w-[600px] p-5 rounded-md space-y-3'>
                    <h3 className='font-medium text-yellow-700'>Tu pago está en proceso</h3>
                    <p className='text-sm text-yellow-700'>
                        Estamos procesando tu pago. Te notificaremos por correo electrónico cuando se confirme.
                    </p>
                    <p className='text-sm'>
                        Si tienes dudas o el pago demora demasiado, contáctanos para ayudarte.
                    </p>
                </div>
