// watch nos permite manipular el nombre a medida que el usuario escribe
...
export const FormProduct = ({ titleForm }: Props) => {
	const {
		...
		setValue,
		watch,
		control, // permite usar campos personalizados con <Controller />.
	...
	// Sirve para "observar" en tiempo real los valores de uno o varios campos del formulario.
